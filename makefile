...
$Bwramp$O:	$Bwramp.c;	$(CC) $(CFLAGS) -c -Isrc -o $@ $Bwramp.c
...
$Bwramp.c:	$Blburg$E src/wramp.md;    $Blburg src/wramp.md    $@
...
$Bwcc$E:	$Blcc$O $Bhost$O;	$(LD) $(LDFLAGS) -o $@ $Blcc$O $Bhost$O 
...
clean::		testclean
		$(RM) $B*$O
		$(RM) $Bdagcheck.c $Balpha.c $Bmips.c $Bwramp.c $Bx86.c $Bsparc.c $Bx86linux.c $Bgram.c
		$(RM) $Brcc.c $Brcc.h
...
C=$Bwcc -A -d0.6 -Wo-lccdir=$(BUILDDIR) -Isrc -I$(BUILDDIR)
triple:	$Brcc$E $Bwcc$E $Bwcpp$E
